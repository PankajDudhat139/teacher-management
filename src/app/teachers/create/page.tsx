...
export default function CreateTeacherPage() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-8 mt-10">
      ...
      <svg className="w-7 h-7 text-blue-500" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0v6m0 0l-3-3m3 3l3-3" /></svg>
      Create Teacher
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div>
        <label className="block text-sm font-semibold text-gray-700 mb-1" htmlFor="birthDate">
          Birth Date
        </label>
        <input
          id="birthDate"
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold py-3 rounded-lg shadow-lg hover:from-blue-700 hover:to-blue-600 transition"
      >
        {loading ? "Saving..." : "Save"}
      </button>
      </form>
